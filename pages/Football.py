...
st.markdown("# European Football Analysis with Tableau and SQL")
...
The SQL code used to process and analyze data can be found here: [Github](https://github.com/AlbertoR94/European_Football_Analysis/blob/main/FootballProject.ipynb)
            """)
